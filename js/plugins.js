...
$(document).ready(function(){
	...
	var currentColor = 'pansy'; // set your favourite theme color here! (yellow, orange, red, pink, pansy, purple, blue, green, turquise, grey, indigodye, melonred)
	...
	/* googleMaps Footer Map */
		...
		var latlng = new google.maps.LatLng(34.16330,-118.38418); <!-- (First Value Longitude, Second Value Latitude), can obtain YOUR coordenates here!: http://universimmedia.pagesperso-orange.fr/geo/loc.htm -->
		var styles = [
			{
		...
		var point0 = new google.maps.LatLng(34.16330,-118.38418); <!-- (Fist Value Longitude, Second Value Latitude), can obtain YOUR coordenates here!: http://universimmedia.pagesperso-orange.fr/geo/loc.htm -->
